...
void rootToLeafPathsSumToK(BinaryTreeNode<int>* root, int k , vector<int> vec){
    ...
    //ih
    vec.push_back(root->data);
    rootToLeafPathsSumToK(root->right , k - root->data , vec);
    rootToLeafPathsSumToK(root->left , k- root->data , vec);
...
void rootToLeafPathsSumToK(BinaryTreeNode<int>* root, int k){
    vector<int> vec;
    rootToLeafPathsSumToK(root , k , vec);
}   
