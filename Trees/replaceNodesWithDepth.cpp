...
void replaceWithDepthValue(TreeNode<int>* root) {
    ...
    //we have pu roots data as 0
    //at eaat iteration now the popped out nodes ddata will signify its depth
    //while queing in the chilren , we put their data as pearents data + 1 ,
    // to signofy their depth
    
  	while(!pendingNode.empty()){
        
        TreeNode<int>* top =pendingNode.front();
        pendingNode.pop();
